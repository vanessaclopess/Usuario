...
namespace Usuario.Application.Services
{
    public class UsuarioService : IUsuarioService
    {
        ...
        public void Add(string login, string nome, string endereco, string password) => _repository.Add(new Domain.Entities.UsuarioEntity(login, nome, endereco, password));
